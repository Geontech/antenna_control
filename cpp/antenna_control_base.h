#ifndef ANTENNA_CONTROL_IMPL_BASE_H
#define ANTENNA_CONTROL_IMPL_BASE_H
...
class antenna_control_base : public Device_impl
{
    friend class ExtendedEvent_MessageEvent_Out_i;

    public:
        antenna_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl);
        antenna_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, char *compDev);
        antenna_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities);
        antenna_control_base(char *devMgr_ior, char *id, char *lbl, char *sftwrPrfl, CF::Properties capacities, char *compDev);
    ...
    protected:
        ProcessThread<antenna_control_base> *serviceThread; 
